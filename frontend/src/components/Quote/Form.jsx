        ...
        <Form style={{ padding: "0 2rem 2rem 2rem" }}>
          ...
          <div className="custom-div">
              <Form.Group controlId="formBasicLanguage">
                ...
                <Form.Control as="select" className="bg-dark text-light custom-placeholder">
                  <option>{context.language === "en" ? "English" : "英文"}</option>
                  <option>{context.language === "en" ? "Chinese" : "华文"}</option>
                </Form.Control>
              </Form.Group>
          </div>

          <div className="custom-div">
              <Form.Group controlId="formBasicLanguage2">
                <Form.Label>{context.language === "en" ? "Target Language" : "目标语言"}</Form.Label>
                <Form.Control as="select" className="bg-dark text-light custom-placeholder">
                  <option>{context.language === "en" ? "English" : "英文"}</option>
                  <option>{context.language === "en" ? "Chinese" : "华文"}</option>
                </Form.Control>
